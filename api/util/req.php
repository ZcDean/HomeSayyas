...
class req
{
    ...
    public static function init()
    {
        ...
        if (count($request_arr) > 0)
        {
            ...
            Log::debug('请求IP:' . util::get_client_ip() . ',请求url:' . util::get_cururl());
            Log::debug('请求参数:' . json_encode(self::$forms));
        }
    ...
    public static function get_file_size($formname)
    {
    	return self::$files[$formname]['size'];
    }
    
    public static function get_file_error($formname)
    {
    	return self::$files[$formname]['error'];
    }
